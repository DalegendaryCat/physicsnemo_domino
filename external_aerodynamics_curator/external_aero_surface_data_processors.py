...
def non_dimensionalize_surface_fields(
    data: ExternalAerodynamicsExtractedDataInMemory,
    air_density: float = PhysicsConstantsHDB.AIR_DENSITY,
    stream_velocity: float = PhysicsConstantsHDB.STREAM_VELOCITY,
) -> ExternalAerodynamicsExtractedDataInMemory:
    """
    Non-dimensionalize surface fields using PhysicsConstantsHDB.
